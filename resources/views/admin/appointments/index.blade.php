                ...
                <div class="appointment-list">
                    @forelse($upcomingVisits as $appointment)
                        <article class="appointment-card">
                            ...
                            <form method="POST" action="{{ route('admin.appointments.status', $appointment) }}">@csrf @method('PATCH')<input type="hidden" name="return_tab" value="upcoming"><input type="hidden" name="return_date" value="{{ $selectedDate }}"><button name="status" value="completed" type="submit">Mark completed</button><button name="status" value="cancelled" type="submit" style="margin-left:6px;">Cancel appointment</button></form>
                        </article>
                    @empty
